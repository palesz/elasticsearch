...
public class VerifierErrorMessagesTests extends ESTestCase {
    ...
    public void testGroupByOrderByFieldFromGroupByFunction() {
        ...
        assertEquals("1:54: Cannot order by non-grouped column [c], expected [b]",
            error("SELECT b, abs, 2 as c FROM (SELECT bool as b, ABS(int) abs FROM test) GROUP BY b ORDER BY abs"));
    }
